  ...
  <b-container class="d-flex justify-content-center align-items-center vh-100 p-0 overflow-hidden" fluid
    ...
    <b-card class="p-4 rounded-4 border-0 shadow-lg" style="max-width: 400px;">
      <div class="text-center mb-4">
        <h4 class="fw-bold text-dark">Bibus</h4>
        <p class="small text-success" v-if="isOnline">Ton fiancé est sur son ordinateur</p>
        <p class="text-muted small bg-warning" v-else>Ton fiancé n'est pas sur son ordinateur !</p>
